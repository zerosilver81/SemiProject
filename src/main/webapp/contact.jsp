                    ...
                    <div class="contact-from section-space--pt_80">
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                ...
                                <form id="#contact-form" class="contact-us-form" action="assets/php/mail.php" method="post">
                                    <div class="single-input-box">
                                        <input type="text" name="con_name" placeholder="이름">
                                    </div>
                                    <div class="single-input-box">
                                        <input type="email" name="con_email" placeholder="이메일">
                                    </div>
                                    <div class="single-input-box">
                                        <input type="text" name="con_phone" placeholder="연락처">
                                    </div>
                                    <div class="single-input-box">
                                        <textarea name="con_message" placeholder="메시지"></textarea>
                                    </div>
                                    <div class="single-input-box">
                                        <button type="submit" class="btn-primary btn-large">문의하기 <i class="icofont-long-arrow-right"></i></button>
                                    </div>
                            ...
                            <div class="col-lg-6 offset-lg-1" data-aos="fade-up">
                                <div class="contact-image">
                                    <img src="assets/images/contact/email-3249062_960_720.webp" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
