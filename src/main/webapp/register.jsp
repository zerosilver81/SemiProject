...
<% } %>
                    ...
                    <div class="row ">
                        <div class="col-lg-6 m-auto">
                            <div class="login-content">
                                ...
                                <form action="/blog/register" method="post" onsubmit="Register__submit(this); return false;">
                                	
                                    <input type="text" name="memberId" placeholder="사용자ID">
                                    <input type="password" name="memberPass" placeholder="비밀번호">
                                    <input type="text" name="memberName" placeholder="이름">
                                    <input type="email" name="memberEmail" placeholder="이메일 주소">
                                    ...
                                    <div class="button-box mt-4">
                                        <button type="submit" class="btn-primary btn-large">회원가입</button>
                                    </div>
    ...
    <!-- register form JS -->
	<script>
	var Register__submitDone = false;
	
	function Register__submit(form) {
		
		if ( Register__submitDone ) {
			alert('처리중입니다.')
			return;
		}
